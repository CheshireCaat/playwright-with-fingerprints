...
If you are having problems with the default plugin, or want to create multiple instances with different settings, you can use a separate exported [createPlugin](src/index.d.ts#L129) method.
...
#### [createPlugin(launcher)](src/index.d.ts#L129)

- `launcher` **[Launcher](src/index.d.ts#L24)** Playwright (or **API** compatible) browser launcher.
