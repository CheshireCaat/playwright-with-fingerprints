...
describe('plugin', () => {
  ...
  describe('#launch()', () => {
    ...
    it('should return the same type as vanilla "playwright" package', async () => {
      assert.notEqual(browser, null, 'Browser should not be null');
      assert.match(browser.constructor.name, /Browser/, 'Browser constructor name should match expected type');
