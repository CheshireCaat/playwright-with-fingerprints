...
describe('plugin', () => {
  ...
  describe('instance', () => {
    ...
    it('should be an instance of "PlaywrightFingerprintPlugin"', () => {
      assert.equal(
        plugin.constructor.name,
        'PlaywrightFingerprintPlugin',
        'Plugin constructor name should be PlaywrightFingerprintPlugin'
      );
    });
    ...
    it('should have all methods from the base plugin', () => {
      Object.getOwnPropertyNames(FingerprintPlugin.prototype).forEach((method) => {
  ...
  describe('#createPlugin()', () => {
    ...
    it('should properly create a separate plugin instance', () => {
      ...
      assert.equal(
        ...
        plugin.constructor,
        'Instance constructor should match the plugin constructor'
      );
    });
  });
});
